...
def start(update, context):
    ...
    # 🛑 يجب أن تعيد END للخروج من أي محادثة جارية
...
def handle_callback_query(update, context):
    ...
    if data == "main_menu":
        ...
        return ConversationHandler.END # 🛑 إنهاء المحادثة عند الرجوع
        
    elif data == "send_custom_design":
        # بدء محادثة طلب الصورة
        return prompt_for_image(update, context) # 🛑 يجب أن تعيد النتيجة هنا

    return ConversationHandler.END # إنهاء في أي حالة أخرى
...
def main():
    ...
    # 1. مُعالج محادثة "ارسال شكل مختلف"
