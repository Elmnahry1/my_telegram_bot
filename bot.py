...
# --------------------
# 2. بيانات القوائم والمنتجات (تم الاحتفاظ بها كما هي للاختصار)
# --------------------
...
# ------------------------------------
# دوال بوكس كتب الكتاب (تم تركها كما هي)
# ------------------------------------
