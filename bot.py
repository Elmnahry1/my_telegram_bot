...
# 🆕 الإضافة المطلوبة: قائمة بوكسات كتب الكتاب
...
aqlam_submenu = [
    {
        ...
        "image": "https://scontent.fcai24-1.fna.fbcdn.net/v/t39.30808-6/475773348_986832329974720_6197915277469223378_n.jpg?stp=dst-jpg_s720x720_tt6&_nc_cat=107&ccb=1-7&_nc_sid=aa7b47&_nc_ohc=KrebndL4u2oQ7kNvwH3smA2&_nc_oc=AdkT6T_o5SpJKdr9FQ5OhX2vuI5Cp3WjQl0pV9vRotIn9csOIX1DX-I9dC3FpvlBLJM&_nc_zt=23&_nc_ht=scontent.fcai24-1.fna&_nc_gid=JFYgN-MxG5oy8y3q9Os6Ew&oh=00_AfhJxajOEm9owiAqd00_zEZ4Hy4qzX7DYATV6p4tWdRxeh&oe=6923BE1B", # ضع رابط الصورة الفعلية للقلم
...
def show_product_page(update, product_callback_data, product_data, is_direct_list=False):
    ...
    for item in products_to_show:
        # 🚨 تم تعديل callback_data لزر الشراء ليناسب المنتجات غير المحفورة
...
def button(update, context):
    ...
    # 6. معالجة القوائم الفرعية التي تعرض المنتجات مباشرة (Bsamat, Wedding_Tissues, Abajorat, Katb_Ketab_Boxes)
    # 🚨 تم إضافة 'katb_ketab_boxes' هنا
