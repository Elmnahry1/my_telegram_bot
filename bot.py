...
# باقي دوال المحادثة (بوكس، صواني، طارات، بصامات، مناديل، محافظ، اقلام) تبقى كما هي.
...
def main():
    ...
    dp.add_handler(mug_handler) # 🔥 المج يجب أن يأتي أولاً
